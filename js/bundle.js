...
function forms(formSelector, modalTimerId) {
  ...
  const message = {
    ...
    success: "Thank you. We'll contact you back soon",
...
function slider(_ref) {
  ...
  function showDotsOnSlide(elements, index) {
    elements.forEach(element => element.style.opacity = '.5');
  ...
  next.addEventListener('click', () => {
    ...
    showDotsOnSlide(dots, slideIndex);
  });
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2023-10-15');
});
})();
